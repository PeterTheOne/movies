...
<html lang="{$lang}">
	<head>
{if isset($title)}
		<title>Movies seen by Peter Grassberger - {$title}</title>
{else}
		<title>Movies seen by Peter Grassberger</title>
{/if}
		...
		<script type="text/javascript" src="js/imdbapiloader.js"></script>
	</head>
